...
export const PokemonHabitat: { [key in OwnZone]: PokemonChance[] } = {
  ranch: [
    ...
    { index: 252, chance: 10, name: "treecko" },
    { index: 255, chance: 10, name: "torchic" },
    { index: 258, chance: 10, name: "mudkip" },
    { index: 263, chance: 10, name: "zigzagoon" },
    { index: 265, chance: 10, name: "wurmple" },
    { index: 266, chance: 10, name: "silcoon" },
    { index: 268, chance: 10, name: "cascoon" },
    { index: 270, chance: 10, name: "lotad" },
    { index: 273, chance: 10, name: "seedot" },
    { index: 276, chance: 10, name: "taillow" },
    { index: 278, chance: 10, name: "wingull" },
    { index: 280, chance: 10, name: "ralts" },
    { index: 285, chance: 10, name: "shroomish" },
    { index: 287, chance: 5, name: "slakoth" },
    { index: 290, chance: 5, name: "nincada" },
    { index: 298, chance: 10, name: "azurill" },
    { index: 300, chance: 10, name: "skitty" },
    { index: 387, chance: 10, name: "turtwig" },
    { index: 390, chance: 10, name: "chimchar" },
    { index: 393, chance: 10, name: "piplup" },
    { index: 396, chance: 10, name: "starly" },
    { index: 399, chance: 10, name: "bidoof" },
    { index: 401, chance: 10, name: "kricketot" },
    { index: 403, chance: 10, name: "shinx" },
    { index: 406, chance: 10, name: "budew" },
    { index: 412, chance: 10, name: "burmy" },
    { index: 415, chance: 10, name: "combee" },
    { index: 420, chance: 10, name: "cherubi" },
    { index: 421, chance: 10, name: "buneary" },
    { index: 431, chance: 10, name: "glameow" },
    { index: 439, chance: 10, name: "mime-jr" },
    { index: 440, chance: 10, name: "happiny" },
  ],
  ...
  underground: [
    ...
    { index: 293, chance: 10, name: "whismur" },
    { index: 304, chance: 10, name: "aron" },
    { index: 316, chance: 10, name: "gulpin" },
    { index: 408, chance: 10, name: "cranidos" },
    { index: 410, chance: 10, name: "shieldon" },
    { index: 438, chance: 10, name: "bonsly" },
    { index: 451, chance: 10, name: "skorupi" },
  ],
  dessert: [
    ...
    { index: 261, chance: 10, name: "poochyena" },
    { index: 296, chance: 10, name: "makuhita" },
    { index: 307, chance: 10, name: "meditite" },
    { index: 309, chance: 10, name: "electrike" },
    { index: 322, chance: 10, name: "numel" },
    { index: 325, chance: 10, name: "spoink" },
    { index: 328, chance: 10, name: "trapinch" },
    { index: 331, chance: 10, name: "cacnea" },
    { index: 343, chance: 10, name: "baltoy" },
    { index: 345, chance: 10, name: "lileep" },
    { index: 347, chance: 10, name: "anorith" },
    { index: 371, chance: 5, name: "bagon" },
    { index: 374, chance: 5, name: "beldum" },
    { index: 433, chance: 5, name: "chingling" },
    { index: 434, chance: 5, name: "stunky" },
    { index: 443, chance: 5, name: "gible" },
    { index: 447, chance: 5, name: "riolu" },
    { index: 449, chance: 5, name: "hippopotas" },
    { index: 453, chance: 10, name: "croagunk" },
  ],
  ...
  sea: [
    ...
    { index: 271, chance: 10, name: "lombre" },
    { index: 274, chance: 10, name: "nuzleaf" },
    { index: 283, chance: 10, name: "surskit" },
    { index: 284, chance: 10, name: "masquerain" },
    { index: 318, chance: 10, name: "carvanha" },
    { index: 320, chance: 10, name: "wailmer" },
    { index: 339, chance: 10, name: "barboach" },
    { index: 341, chance: 10, name: "corphish" },
    { index: 349, chance: 10, name: "feebas" },
    { index: 363, chance: 5, name: "spheal" },
    { index: 366, chance: 5, name: "clamperl" },
    { index: 370, chance: 5, name: "luvdisc" },
    { index: 418, chance: 5, name: "buizel" },
    { index: 422, chance: 10, name: "shellos" },
    { index: 456, chance: 10, name: "finneon" },
    { index: 458, chance: 10, name: "mantyke" },
  ],
  sky: [
    ...
    { index: 277, chance: 10, name: "swellow" },
    { index: 279, chance: 10, name: "pelipper" },
    { index: 333, chance: 10, name: "swablu" },
    { index: 397, chance: 10, name: "staravia" },
    { index: 425, chance: 10, name: "drifloon" },
    { index: 436, chance: 5, name: "bronzor" },
    { index: 441, chance: 5, name: "chatot" },
  ],
