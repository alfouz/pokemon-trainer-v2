...
export const PokemonHabitat: { [key in OwnZone]: PokemonChance[] } = {
  ...
  night: [
    { index: 30, chance: 30, name: "nidorina" },
    { index: 33, chance: 30, name: "nidorino" },
    { index: 42, chance: 30, name: "golbat" },
    { index: 44, chance: 25, name: "gloom" },
    { index: 70, chance: 25, name: "weepinbell" },
    { index: 88, chance: 35, name: "grimer" },
    { index: 93, chance: 25, name: "haunter" },
    { index: 96, chance: 30, name: "drowzee" },
    { index: 111, chance: 15, name: "rhyhorn" },
    { index: 193, chance: 10, name: "yanma" },
    { index: 198, chance: 25, name: "murkrow" },
    { index: 204, chance: 15, name: "pineco" },
    { index: 206, chance: 2, name: "dunsparce" },
    { index: 207, chance: 15, name: "gligar" },
    { index: 228, chance: 20, name: "houndour" },
    { index: 275, chance: 5, name: "shiftry" },
    { index: 302, chance: 5, name: "sableye" },
    { index: 305, chance: 5, name: "lairon" },
    { index: 329, chance: 5, name: "vibrava" },
    { index: 353, chance: 25, name: "shuppet" },
    { index: 355, chance: 25, name: "duskull" },
    { index: 360, chance: 15, name: "wynaut" },
    { index: 404, chance: 10, name: "luxio" },
  ],
  theater: [
    { index: 20, chance: 15, name: "raticate" },
    { index: 57, chance: 20, name: "primeape" },
    { index: 63, chance: 30, name: "abra" },
    { index: 64, chance: 20, name: "kadabra" },
    { index: 67, chance: 20, name: "machoke" },
    { index: 77, chance: 20, name: "ponyta" },
    { index: 84, chance: 15, name: "doduo" },
    { index: 100, chance: 25, name: "voltorb" },
    { index: 162, chance: 15, name: "furret" },
    { index: 213, chance: 15, name: "shuckle" },
    { index: 235, chance: 15, name: "smeargle" },
    { index: 262, chance: 15, name: "mightyena" },
    { index: 264, chance: 15, name: "linoone" },
    { index: 281, chance: 15, name: "kirlia" },
    { index: 288, chance: 5, name: "vigoroth" },
    { index: 294, chance: 10, name: "loudred" },
    { index: 299, chance: 15, name: "nosepass" },
    { index: 301, chance: 15, name: "delcatty" },
    { index: 311, chance: 20, name: "plusle" },
    { index: 312, chance: 20, name: "minun" },
    { index: 326, chance: 5, name: "grumpig" },
    { index: 327, chance: 15, name: "spinda" },
    { index: 400, chance: 15, name: "bibarel" },
    { index: 417, chance: 20, name: "pachirisu" },
    { index: 446, chance: 10, name: "munchlax" },
  ],

  city: [
    { index: 24, chance: 15, name: "arbok" },
    { index: 49, chance: 15, name: "venomoth" },
    { index: 82, chance: 15, name: "magneton" },
    { index: 89, chance: 15, name: "muk" },
    { index: 97, chance: 15, name: "hypno" },
    { index: 105, chance: 15, name: "marowak" },
    { index: 110, chance: 15, name: "weezing" },
    { index: 132, chance: 10, name: "ditto" },
    { index: 164, chance: 20, name: "noctowl" },
    { index: 168, chance: 20, name: "ariados" },
    { index: 171, chance: 20, name: "lanturn" },
    { index: 189, chance: 15, name: "jumpluff" },
    { index: 200, chance: 15, name: "misdreavus" },
    { index: 209, chance: 30, name: "snubbull" },
    { index: 229, chance: 15, name: "houndoom" },
    { index: 231, chance: 20, name: "phanpy" },
    { index: 292, chance: 5, name: "shedinja" },
    { index: 303, chance: 15, name: "mawile" },
    { index: 317, chance: 15, name: "swalot" },
    { index: 324, chance: 25, name: "torkoal" },
    { index: 335, chance: 20, name: "zangoose" },
    { index: 336, chance: 20, name: "seviper" },
    { index: 352, chance: 10, name: "kecleon" },
    { index: 356, chance: 5, name: "dusclops" },
    { index: 432, chance: 15, name: "purugly" },
    { index: 435, chance: 15, name: "skuntank" },
    { index: 442, chance: 5, name: "spiritomb" },
    { index: 452, chance: 10, name: "drapion" },
    { index: 455, chance: 15, name: "carnivine" },
  ],
  flower: [
    { index: 2, chance: 15, name: "ivysaur" },
    { index: 5, chance: 15, name: "charmeleon" },
    { index: 8, chance: 15, name: "wartortle" },
    { index: 12, chance: 35, name: "butterfree" },
    { index: 15, chance: 35, name: "beedrill" },
    { index: 47, chance: 25, name: "parasect" },
    { index: 102, chance: 35, name: "exeggcute" },
    { index: 114, chance: 15, name: "tangela" },
    { index: 119, chance: 10, name: "seaking" },
    { index: 123, chance: 10, name: "scyther" },
    { index: 127, chance: 10, name: "pinsir" },
    { index: 153, chance: 15, name: "bayleef" },
    { index: 156, chance: 15, name: "quilava" },
    { index: 159, chance: 15, name: "croconaw" },
    { index: 166, chance: 35, name: "ledian" },
    { index: 180, chance: 20, name: "flaaffy" },
    { index: 185, chance: 15, name: "sudowoodo" },
    { index: 192, chance: 35, name: "sunflora" },
    { index: 203, chance: 15, name: "girafarig" },
    { index: 205, chance: 5, name: "forretress" },
    { index: 212, chance: 5, name: "scizor" },
    { index: 214, chance: 5, name: "heracross" },
    { index: 216, chance: 25, name: "teddiursa" },
    { index: 234, chance: 15, name: "stantler" },
    { index: 241, chance: 15, name: "miltank" },
    { index: 253, chance: 15, name: "grovyle" },
    { index: 256, chance: 15, name: "combusken" },
    { index: 259, chance: 15, name: "marshtomp" },
    { index: 267, chance: 35, name: "beautifly" },
    { index: 269, chance: 35, name: "dustox" },
    { index: 271, chance: 15, name: "ludicolo" },
    { index: 286, chance: 20, name: "breloom" },
    { index: 291, chance: 20, name: "ninjask" },
    { index: 313, chance: 35, name: "volbeat" },
    { index: 314, chance: 35, name: "illumise" },
    { index: 315, chance: 25, name: "roselia" },
    { index: 357, chance: 5, name: "tropius" },
    { index: 388, chance: 15, name: "grotle" },
    { index: 391, chance: 15, name: "monferno" },
    { index: 394, chance: 15, name: "prinplup" },
    { index: 402, chance: 35, name: "kricketune" },
    { index: 413, chance: 25, name: "wormadam-plant" },
    { index: 414, chance: 35, name: "mothim" },
    { index: 416, chance: 5, name: "vespiquen" },
    { index: 421, chance: 25, name: "cherrim" },
    { index: 470, chance: 10, name: "leafeon" },
  ],

  oversky: [
    { index: 18, chance: 15, name: "pidgeot" },
    { index: 36, chance: 15, name: "clefable" },
    { index: 40, chance: 15, name: "wigglytuff" },
    { index: 113, chance: 15, name: "chansey" },
    { index: 148, chance: 10, name: "dragonair" },
    { index: 176, chance: 15, name: "togetic" },
    { index: 178, chance: 15, name: "xatu" },
    { index: 184, chance: 15, name: "azumarill" },
    { index: 227, chance: 10, name: "skarmory" },
    { index: 242, chance: 5, name: "blissey" },
    { index: 282, chance: 5, name: "gardevoir" },
    { index: 334, chance: 5, name: "altaria" },
    { index: 337, chance: 15, name: "lunatone" },
    { index: 338, chance: 15, name: "solrock" },
    { index: 344, chance: 10, name: "claydol" },
    { index: 358, chance: 15, name: "chimecho" },
    { index: 359, chance: 10, name: "absol" },
    { index: 398, chance: 15, name: "staraptor" },
    { index: 429, chance: 10, name: "mismagius" },
    { index: 437, chance: 5, name: "bronzong" },
    { index: 468, chance: 5, name: "togekiss" },
    { index: 475, chance: 5, name: "gallade" },
  ],
  snow: [
    { index: 28, chance: 10, name: "sandslash" },
    { index: 75, chance: 15, name: "graveler" },
    { index: 87, chance: 10, name: "dewgong" },
    { index: 91, chance: 10, name: "cloyster" },
    { index: 117, chance: 15, name: "seadra" },
    { index: 124, chance: 10, name: "jynx" },
    { index: 215, chance: 15, name: "sneasel" },
    { index: 221, chance: 10, name: "piloswine" },
    { index: 225, chance: 25, name: "delibird" },
    { index: 351, chance: 20, name: "castform" },
    { index: 361, chance: 25, name: "snorunt" },
    { index: 362, chance: 10, name: "glalie" },
    { index: 364, chance: 35, name: "sealeo" },
    { index: 375, chance: 25, name: "metang" },
    { index: 459, chance: 25, name: "snover" },
    { index: 460, chance: 10, name: "abomasnow" },
    { index: 461, chance: 5, name: "weavile" },
    { index: 471, chance: 10, name: "glaceon" },
    { index: 473, chance: 3, name: "mamoswine" },
    { index: 478, chance: 10, name: "froslass" },
  ],

  grocery: [
    { index: 26, chance: 20, name: "raichu" },
    { index: 38, chance: 15, name: "ninetales" },
    { index: 45, chance: 15, name: "vileplume" },
    { index: 53, chance: 20, name: "persian" },
    { index: 71, chance: 15, name: "victreebel" },
    { index: 85, chance: 15, name: "dodrio" },
    { index: 94, chance: 15, name: "gengar" },
    { index: 101, chance: 15, name: "electrode" },
    { index: 108, chance: 25, name: "lickitung" },
    { index: 122, chance: 15, name: "mr-mime" },
    { index: 125, chance: 10, name: "electabuzz" },
    { index: 135, chance: 10, name: "jolteon" },
    { index: 143, chance: 5, name: "snorlax" },
    { index: 181, chance: 10, name: "ampharos" },
    { index: 195, chance: 10, name: "quagsire" },
    { index: 196, chance: 15, name: "espeon" },
    { index: 210, chance: 20, name: "granbull" },
    { index: 217, chance: 5, name: "ursaring" },
    { index: 310, chance: 10, name: "manectric" },
    { index: 354, chance: 10, name: "banette" },
    { index: 405, chance: 5, name: "luxray" },
    { index: 426, chance: 10, name: "drifblim" },
    { index: 430, chance: 5, name: "honchkrow" },
    { index: 457, chance: 15, name: "lumineon" },
    { index: 462, chance: 5, name: "magnezone" },
    { index: 463, chance: 5, name: "lickilicky" },
    { index: 465, chance: 5, name: "tangrowth" },
    { index: 479, chance: 10, name: "rotom" },
  ],
  classic: [
    { index: 3, chance: 10, name: "venusaur" },
    { index: 31, chance: 10, name: "nidoqueen" },
    { index: 34, chance: 10, name: "nidoking" },
    { index: 51, chance: 15, name: "dugtrio" },
    { index: 55, chance: 15, name: "golduck" },
    { index: 68, chance: 5, name: "machamp" },
    { index: 78, chance: 10, name: "rapidash" },
    { index: 103, chance: 10, name: "exeggutor" },
    { index: 106, chance: 15, name: "hitmonlee" },
    { index: 107, chance: 15, name: "hitmonchan" },
    { index: 128, chance: 10, name: "tauros" },
    { index: 154, chance: 10, name: "meganium" },
    { index: 169, chance: 5, name: "crobat" },
    { index: 182, chance: 10, name: "bellossom" },
    { index: 186, chance: 10, name: "politoed" },
    { index: 197, chance: 10, name: "umbreon" },
    { index: 237, chance: 15, name: "hitmontop" },
    { index: 254, chance: 10, name: "sceptile" },
    { index: 295, chance: 10, name: "exploud" },
    { index: 297, chance: 15, name: "hariyama" },
    { index: 308, chance: 15, name: "medicham" },
    { index: 332, chance: 15, name: "cacturne" },
    { index: 389, chance: 10, name: "torterra" },
    { index: 407, chance: 10, name: "roserade" },
    { index: 419, chance: 10, name: "floatzel" },
    { index: 424, chance: 10, name: "ambipom" },
    { index: 428, chance: 20, name: "lopunny" },
    { index: 444, chance: 5, name: "gabite" },
    { index: 448, chance: 5, name: "lucario" },
    { index: 454, chance: 15, name: "toxicroak" },
    { index: 466, chance: 10, name: "electivire" },
    { index: 469, chance: 10, name: "yanmega" },
    { index: 472, chance: 10, name: "gliscor" },
    { index: 477, chance: 10, name: "dusknoir" },
  ],

  volcan: [
    { index: 6, chance: 10, name: "charizard" },
    ...
    { index: 476, chance: 15, name: "probopass" },
  ],
  undersea: [
    { index: 9, chance: 10, name: "blastoise" },
    { index: 62, chance: 15, name: "poliwrath" },
    { index: 73, chance: 15, name: "tentacruel" },
    { index: 80, chance: 15, name: "slowbro" },
    { index: 99, chance: 20, name: "kingler" },
    { index: 121, chance: 10, name: "starmie" },
    { index: 130, chance: 5, name: "gyarados" },
    { index: 131, chance: 5, name: "lapras" },
    { index: 134, chance: 15, name: "vaporeon" },
    ...
    { index: 211, chance: 20, name: "qwilfish" },
    { index: 224, chance: 15, name: "octillery" },
    { index: 226, chance: 15, name: "mantine" },
    { index: 230, chance: 10, name: "kingdra" },
    { index: 260, chance: 10, name: "swampert" },
    { index: 319, chance: 15, name: "sharpedo" },
    { index: 321, chance: 5, name: "wailord" },
    { index: 340, chance: 15, name: "whiscash" },
    { index: 342, chance: 15, name: "crawdaunt" },
    { index: 346, chance: 15, name: "cradily" },
    { index: 348, chance: 15, name: "armaldo" },
    { index: 350, chance: 5, name: "milotic" },
    { index: 365, chance: 10, name: "walrein" },
    { index: 367, chance: 15, name: "huntail" },
    { index: 368, chance: 15, name: "gorebyss" },
    { index: 369, chance: 5, name: "relicanth" },
    { index: 395, chance: 10, name: "empoleon" },
    { index: 423, chance: 15, name: "gastrodon" },
  ],

  unknown: [
    { index: 65, chance: 10, name: "alakazam" },
    { index: 144, chance: 2, name: "articuno" },
    { index: 145, chance: 2, name: "zapdos" },
    { index: 146, chance: 2, name: "moltres" },
    { index: 149, chance: 3, name: "dragonite" },
    { index: 202, chance: 10, name: "wobbuffet" },
    { index: 233, chance: 10, name: "porygon2" },
    { index: 243, chance: 2, name: "raikou" },
    { index: 244, chance: 2, name: "entei" },
    { index: 245, chance: 2, name: "suicune" },
    { index: 248, chance: 3, name: "tyranitar" },
    { index: 249, chance: 1, name: "lugia" },
    { index: 250, chance: 1, name: "ho-oh" },
    { index: 289, chance: 3, name: "slaking" },
    { index: 373, chance: 3, name: "salamence" },
    { index: 376, chance: 3, name: "metagross" },
    { index: 377, chance: 2, name: "regirock" },
    { index: 378, chance: 2, name: "regice" },
    { index: 379, chance: 2, name: "registeel" },
    { index: 380, chance: 2, name: "latias" },
    { index: 381, chance: 2, name: "latios" },
    { index: 445, chance: 3, name: "garchomp" },
    { index: 474, chance: 5, name: "porygon-z" },
    { index: 480, chance: 2, name: "uxie" },
    { index: 481, chance: 2, name: "mesprit" },
  ...
  space: [
    ...
    { index: 151, chance: 1, name: "mew" },
    { index: 251, chance: 1, name: "celebi" },
    { index: 382, chance: 1, name: "kyogre" },
    { index: 383, chance: 1, name: "groudon" },
    { index: 384, chance: 1, name: "rayquaza" },
    { index: 385, chance: 1, name: "jirachi" },
    { index: 386, chance: 1, name: "deoxys-normal" },
    { index: 483, chance: 1, name: "dialga" },
    { index: 484, chance: 1, name: "palkia" },
    { index: 485, chance: 1, name: "heatran" },
    { index: 486, chance: 1, name: "regigigas" },
    { index: 487, chance: 1, name: "giratina-altered" },
    { index: 490, chance: 1, name: "manaphy" },
    { index: 492, chance: 1, name: "shaymin-land" },
    { index: 493, chance: 1, name: "arceus" },
  ],
};
